...
<div id="sit_use_wbtn">
    <a href="<?php echo $itemuse_form; ?>" class="qa_wr itemuse_form btn_b02" onclick="return false;">후기작성</a>
    <a href="<?php echo $itemuse_list; ?>" id="itemuse_list" class="btn_b03">더보기</a>
</div>
