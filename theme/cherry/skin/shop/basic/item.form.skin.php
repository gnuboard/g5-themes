...
<div id="sit_ov_wrap">
    ...
    <section id="sit_ov" class="2017_renewal_itemform">
        ...
        <div id="sit_ov_btn">
            ...
            <a href="javascript:popup_stocksms('<?php echo $it['it_id']; ?>');" id="sit_btn_alm" class="btn_b03"><i class="fa fa-bell-o" aria-hidden="true"></i> 재입고알림</a>
            <?php } ?>
            <a href="javascript:item_wish(document.fitem, '<?php echo $it['it_id']; ?>');" id="sit_btn_wish" class="btn_b03"><i class="fa fa-heart-o" aria-hidden="true"></i><span class="sound_only">위시리스트</span></a>
