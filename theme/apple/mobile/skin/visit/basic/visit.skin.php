...
<aside id="visit">
    ...
    <dl>
        ...
        <dt><a href="<?php echo G5_BBS_URL ?>/current_connect.php" id="snb_cnt">현재접속자 <i class="fa fa-angle-right" aria-hidden="true"></i></a></dt>
        <dd><?php echo connect('theme/basic'); // 현재 접속자수 ?></dd>
    </dl>
