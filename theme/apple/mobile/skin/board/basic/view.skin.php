...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        ...
        <div class="bo_v_name">
            ...
            <span class="date"><span class="sound_only">작성일</span> <?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></span>
        </div>
        <div class="bo_v_cmt">
            <span ><i class="fa fa-eye" aria-hidden="true"></i> <?php echo number_format($view['wr_hit']) ?>회</span>
            <span><i class="fa fa-commenting-o" aria-hidden="true"></i> <?php echo number_format($view['wr_comment']) ?>건</span>
        </div>
    </section>
...
<?php if(array_filter($view['link'])) { ?>
    ...
    <div class="btn_top top"> 
        <a href="<?php echo $list_href ?>" class="btn_b04 btn">목록</a>
        <?php if ($reply_href) { ?><a href="<?php echo $reply_href ?>" class="btn_b04 btn">답변</a><?php } ?>
