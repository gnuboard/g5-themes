...
<div id="ssch">
    ...
    <div id="ssch_frm">
        ...
        <div>
            <strong class="ssch_tit">검색범위</strong>
        ...
        <div>
            <strong class="ssch_tit">상품가격 (원)</strong>
            <label for="ssch_qfrom" class="sound_only">최소 가격</label>
            <input type="text" name="qfrom" value="<?php echo $qfrom; ?>" id="ssch_qfrom" class="frm_input" size="8"> ~
            <label for="ssch_qto" class="sound_only">최대 가격</label>
            <input type="text" name="qto" value="<?php echo $qto; ?>" id="ssch_qto" class="frm_input" size="8"> 까지<br>
        </div>
        <div>
            <label for="ssch_q" class="ssch_lbl ssch_tit">검색어</label>
