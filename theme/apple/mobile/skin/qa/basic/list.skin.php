...
<div id="bo_list">
    ...
    <div class="btn_top top">
        <?php if ($admin_href) { ?><a href="<?php echo $admin_href ?>" class="btn_admin btn"><i class="fa fa-user-circle" aria-hidden="true"></i><span class="sound_only">관리자</span></a><?php } ?>
        <?php if ($write_href) { ?><a href="<?php echo $write_href ?>" class="btn_b02 btn"><i class="fa fa-pencil" aria-hidden="true"></i> 문의등록</a><?php } ?>
    </div>
    <?php } ?>
        ...
        <ul>
            ...
            <li class="bo_li<?php if ($is_checkbox) echo ' bo_adm'; ?>">
                ...
                <div class="li_info">
                    ...
                    <span class="bo_date"> <?php echo $list[$i]['date'] ?> </span>
