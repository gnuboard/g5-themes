...
<aside id="ol_after" class="ol">
    ...
    <div id="ol_after_hd">
        ...
        <div id="ol_after_btn">
            <a href="<?php echo G5_BBS_URL ?>/logout.php" id="ol_after_logout" class="btn02">로그아웃</a>
        </div>
    </div>
    ...
    <ul id="ol_after_private">
        <li id="ol_after_memo">
            <a href="<?php echo G5_BBS_URL ?>/memo.php" target="_blank" class="win_memo">
                <i class="fa fa-envelope"></i><span class="sound_only">안 읽은 </span>쪽지
                <strong><?php echo $memo_not_read ?></strong>
            </a>
        </li>
        <li id="ol_after_pt">
            <a href="<?php echo G5_BBS_URL ?>/point.php" target="_blank" class="win_point">
                <i class="fa fa-database"></i><span> 포인트</span>
        ...
        <li id="ol_after_cp">
            ...
            <strong><?php echo number_format($cp_count); ?></strong> </a>
        </li>
        <li><a href="<?php echo G5_SHOP_URL ?>/mypage.php"><i class="fa fa-user" aria-hidden="true"></i> 마이페이지</a></li>
        <li id="ol_after_scrap">
            <a href="<?php echo G5_BBS_URL ?>/scrap.php" target="_blank" class="win_memo"><i class="fa fa-thumb-tack"></i> 스크랩</a>
        </li>
