            ...
            ?>
                <li class="gnb_1dli">
                    ...
                    for ($k=0; $row2=sql_fetch_array($result2); $k++) {
                        if($k == 0)
                            echo '<button type="button" class="btn_gnb_op"><span class="sound_only">하위분류</span><i class="fa fa-sort-down"></i></button><ul class="gnb_2dul">'.PHP_EOL;
                    ?>
...
<div id="wrapper">
    ...
    <div id="container">
    <?php if (!defined("_INDEX_")) { ?><h2 id="container_title" class="top"><?php echo $g5['title'] ?></h2><?php } ?>
