    ...
    <div id="bo_list_wr">
        ...
        <input type="hidden" name="page" value="<?php echo $page; ?>">
            ...
            <ul class="btn_bo_user">
                <?php if ($admin_href) { ?><li><a href="<?php echo $admin_href ?>" class="admin list_btn"><i class="fa fa-user-circle" aria-hidden="true"></i><span class="sound_only"> 관리자</span></a></li><?php } ?>
