            ...
            <ul>
                <li>
                    ...
                    if ($config['cf_cert_use']) {
                        $desc_name = '<span class="frm_info"> 본인확인 시 자동입력</span>';
                        $desc_phone = '<span class="frm_info"> 본인확인 시 자동입력</span>';
        ...
        <div class="tbl_frm01 tbl_wrap register_form_inner">
            ...
            <ul>
                ...
                <li>
                    ...
                    <input type="file" name="mb_icon" id="reg_mb_icon"><br/>
                ...
                <li class="reg_mb_img_file">
                    ...
                    <input type="file" name="mb_img" id="reg_mb_img"><br/>
