...
<header id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="tnb">
            ...
            <button type="button" id="sch_op_btn" ><i class="fa fa-search"x></i><span class="sound_only">검색</span></button>
            <?php if ($is_member) {  ?>
        ...
        <div id="gnb" class="hd_div">
            <button type="button" id="gnb_close" class="hd_closer"><i class="fa fa-times"></i><span class="sound_only">메뉴 닫기</span></button>
        ...
        <div id="hd_sch">
            <h2 class="sch_tit">사이트 내 전체검색</h2>
...
<div id="wrapper">
    ...
    <div id="container">
    <?php if (!defined("_INDEX_")) { ?><h2 id="container_title"><a href="javascript:history.back()" class="btn_back"><i class="fa fa-chevron-left" aria-hidden="true"></i> <span class="sound_only">뒤로</span></a><?php echo $g5['title'] ?></h2><?php } ?>
