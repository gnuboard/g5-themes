...
<div id="bo_list">
    ...
    <div class="board_wr">
        <button type="button" class="op_search_btn"><i class="fa fa-search" aria-hidden="true"></i><span class="sound_only">검색열기</span></button>
        <fieldset id="bo_sch">
            ...
            <button type="button" class="sch_close"><i class="fa fa-times-circle" aria-hidden="true"></i></button>
        </fieldset>       
        ...
        <ul class="btn_bo_user">
            ...
            <?php if ($is_checkbox) { ?>
            <li>
                <button type="button" class="edit_op_btn"><i class="fa fa-ellipsis-v" aria-hidden="true"></i><span class="sound_only">게시판 리스트수정</span></button>
            ...
            <ul>
                ...
                <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                    ...
                    <div class="bo_info">
                        ...
                        <?php if ($list[$i]['comment_cnt']) { ?><span class="bo_cmt"><span class="sound_only">댓글</span><i class="fa fa-commenting-o" aria-hidden="true"></i><?php echo $list[$i]['comment_cnt']; ?></span><?php } ?>
