...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <div id="bo_button">
        ...
        <li class="bo_btn_li"><a href="<?php echo $list_href ?>" class="view_btn"><i class="fa fa-list" aria-hidden="true"></i><span class="sound_only">목록</span></a></li>
            ...
            <li class="bo_btn_li"><button type="button" class="edit_op_btn view_btn"><i class="fa fa-ellipsis-v" aria-hidden="true"></i><span class="sound_only">게시판 리스트수정</span></button>
