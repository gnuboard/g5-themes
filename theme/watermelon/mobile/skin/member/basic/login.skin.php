...
<div id="mb_login">
    ...
    <input type="hidden" name="url" value="<?php echo $login_url ?>">
       ...
       <div class="mbskin">
        <a href="<?php echo G5_URL ?>" class="login_logo"><img src="<?php echo G5_IMG_URL ?>/logo.png" alt="<?php echo $config['cf_title']; ?>"></a>
        
        <fieldset id="login_fs">
            <legend>회원로그인</legend>
            <div class="id_wr">
                <label for="login_id" class="id_lb">회원아이디<strong class="sound_only"> 필수</strong></label>
                <input type="text" name="mb_id" id="login_id" required class="login_input required">
            </div>
            <div class="id_wr">
                <label for="login_pw" class="pw_lb">비밀번호<strong class="sound_only"> 필수</strong></label>
                <input type="password" name="mb_password" id="login_pw" required class="login_input required" >
            </div>
