    ...
    <section id="sit_ov" class="2017_renewal_itemform">
        ...
        <div class="sit_ov_wr">
            ...
            <div class="sit_ov_tbl">
                <button type="button" class="btn_ist">INSTRUCTION <i class="fa fa-angle-down" aria-hidden="true"></i></button>
                <table >
                <colgroup>
                    <col class="grid_2">
                    <col>
        ...
        <div id="sit_star_sns">
            ...
            <a href="javascript:item_wish(document.fitem, '<?php echo $it['it_id']; ?>');" id="sit_btn_wish"><i class="fa fa-heart-o" aria-hidden="true"></i> 위시리스트(<?php echo get_wishlist_count_by_item($it['it_id']); ?>)</span></a>
