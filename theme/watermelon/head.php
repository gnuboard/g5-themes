...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div class="hd_sch_wr">
            <div id="tnb">
                <button type="button" id="sch_op_btn"><i class="fa fa-search" aria-hidden="true"></i><span class="sound_only">검색열기</span></button>
                <?php if ($is_member) {  ?>
            ...
            <div class="sch_open">
                ...
                <button type="button" id="sch_close_btn">닫기</button>
            </div>            
        </div>
