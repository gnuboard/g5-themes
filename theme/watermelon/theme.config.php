...
$theme_config = array(
    ...
    'de_type1_img_width'            => 255,     // PC 히트상품 이미지 폭
    'de_type1_img_height'           => 255,     // PC 히트상품 이미지 높이
    ...
    'de_type2_img_width'            => 280,     // PC 추천상품 이미지 폭
    'de_type2_img_height'           => 200,     // PC 추천상품 이미지 높이
    ...
    'de_type3_img_width'            => 255,     // PC 최신상품 이미지 폭
    'de_type3_img_height'           => 255,     // PC 최신상품 이미지 높이
    'de_type4_list_use'             => 1,       // PC 인기상품 출력
    'de_type4_list_skin'            => 'main.50.skin.php', // PC 인기상품 출력스킨
    'de_type4_list_mod'             => 15,       // PC 인기상품 출력 1줄당 이미지 수
    ...
    'de_type5_img_width'            => 330,     // PC 할인상품 이미지 폭
    'de_type5_img_height'           => 330,     // PC 할인상품 이미지 높이
    ...
    'de_mobile_type4_list_row'      => 3,       // 모바일 인기상품 출력 출력 줄 수
    ...
    'de_mobile_type5_list_skin'     => 'main.40.skin.php', // 모바일 할인상품 출력스킨
    'de_mobile_type5_list_mod'      => 4,       // 모바일 할인상품 출력 1줄당 이미지 수
    'de_mobile_type5_list_row'      => 1,       // 모바일 할인상품 출력 출력 줄 수
    'de_mobile_type5_img_width'     => 500,     // 모바일 할인상품 이미지 폭
    'de_mobile_type5_img_height'    => 500,     // 모바일 할인상품 이미지 높이
    'de_rel_list_use'               => 1,       // 관련상품 출력
    'de_rel_list_skin'              => 'relation.10.skin.php',  // 관련상품 출력 스킨
    'de_rel_list_mod'               => 12,       // 관련상품 1줄당 이미지 수
    'de_rel_img_width'              => 165,     // 관련상품 이미지 폭
    'de_rel_img_height'             => 165,     // 관련상품 이미지 높이
    ...
    'de_search_img_width'           => 260,     // 검색상품 이미지 폭
    'de_search_img_height'          => 260,     // 검색상품 이미지 높이
    ...
    'ca_img_width'                  => 260,     // 분류 리스트 이미지 폭
    'ca_img_height'                 => 260,     // 분류 리스트 이미지 높이
    ...
    define('G5_THEME_ADM_DIR', '/theme/watermelon/theme_adm/footerinfo.php');
