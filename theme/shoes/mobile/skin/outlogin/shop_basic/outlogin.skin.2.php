    ...
    <ul id="ol_after_private">
        <li>
            <a href="<?php echo G5_BBS_URL ?>/point.php" target="_blank" id="ol_after_pt" class="win_point">
                ...
                <strong><?php echo $point ?> 점</strong>
            </a>
        </li>

        <li>
            <a href="<?php echo G5_SHOP_URL ?>/coupon.php" target="_blank" id="ol_after_coupon" class="win_scrap"><span class="sound_only">쿠폰</span>
            <strong><?php echo number_format($cp_count); ?> 장</strong>
            </a>
        </li>
    </ul>
