...
<section id="sit_use_list">
    ...
    ?>
        ...
        <li class="sit_use_li">
                ...
                <button type="button" class="sit_use_li_title">더보기 <i class="fa fa-angle-down" aria-hidden="true"></i></button>
                <dl class="sit_use_dl">
                    <dt>평점<dt>
    ...
    ?>
        <div id="sit_use_wbtn">
            ...
            <a href="<?php echo $itemuse_list; ?>" class="itemuse_list"><span class="sound_only">더보기</span><i class="fa fa-plus" aria-hidden="true"></i></a>
        </div>
