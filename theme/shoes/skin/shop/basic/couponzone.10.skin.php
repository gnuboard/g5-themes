...
<section class="couponzone_list">
    <h2>다운로드 쿠폰</h2>
    <p class="cpz_p"><?php echo $default['de_admin_company_name']; ?> 회원이시라면 쿠폰 다운로드 후 바로 사용하실 수 있습니다.</p>
...
<section class="couponzone_list" id="point_coupon">
    <h2>포인트 쿠폰</h2>
    <p class="cpz_p">보유하신 <?php echo $default['de_admin_company_name']; ?> 회원 포인트를 쿠폰으로 교환하실 수 있습니다.</p>
