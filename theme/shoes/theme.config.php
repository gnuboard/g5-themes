...
$theme_config = array(
    ...
    'de_type1_img_width'            => 225,     // PC 히트상품 이미지 폭
    'de_type1_img_height'           => 225,     // PC 히트상품 이미지 높이
    ...
    'de_mobile_type2_list_mod'      => 10,       // 모바일 추천상품 출력 1줄당 이미지 수
    'de_mobile_type2_list_row'      => 1,       // 모바일 추천상품 출력 출력 줄 수
    'de_mobile_type2_img_width'     => 200,     // 모바일 추천상품 이미지 폭
    'de_mobile_type2_img_height'    => 200,     // 모바일 추천상품 이미지 높이
    'de_mobile_type3_list_use'      => 1,       // 모바일 최신상품 출력
    'de_mobile_type3_list_skin'     => 'main.20.skin.php', // 모바일 최신상품 출력스킨
    'de_mobile_type3_list_mod'      => 10,       // 모바일 최신상품 출력 1줄당 이미지 수
    'de_mobile_type3_list_row'      => 1,       // 모바일 최신상품 출력 출력 줄 수
    'de_mobile_type3_img_width'     => 200,     // 모바일 최신상품 이미지 폭
    ...
    'de_mobile_type4_list_mod'      => 5,       // 모바일 인기상품 출력 1줄당 이미지 수
    'de_mobile_type4_list_row'      => 1,       // 모바일 인기상품 출력 출력 줄 수
    'de_mobile_type4_img_width'     => 150,     // 모바일 인기상품 이미지 폭
    'de_mobile_type4_img_height'    => 150,     // 모바일 인기상품 이미지 높이
    'de_mobile_type5_list_use'      => 1,       // 모바일 할인상품 출력
    'de_mobile_type5_list_skin'     => 'main.20.skin.php', // 모바일 할인상품 출력스킨
    'de_mobile_type5_list_mod'      => 10,       // 모바일 할인상품 출력 1줄당 이미지 수
    ...
    'de_rel_img_width'              => 100,     // 관련상품 이미지 폭
    'de_rel_img_height'             => 100,     // 관련상품 이미지 높이
    ...
    'ev_img_width'                  => 220,     // 이벤트 리스트 이미지 폭
    'ev_img_height'                 => 220,     // 이벤트 리스트 이미지 높이
...
define('G5_THEME_ADM_DIR', '/theme/shoes/theme_adm/footerinfo.php');
