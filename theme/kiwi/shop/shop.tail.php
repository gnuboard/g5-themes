...
<div id="ft">
    ...
    <div class="ft_cs ft_box">
        <h2>COSTOMER CENTER</h2>
        <div>
            
            <strong class="cs_tel">01-234-5678</strong>
            <p class="cs_info">월-금 am 9:00 - pm 05:00<br>점심시간 : am 12:00 - pm 01:00</p>
            <a href="<?php echo G5_BBS_URL; ?>/faq.php" class="link_cs btn_s btn_b01">FAQ</a>
            <a href="<?php echo G5_BBS_URL; ?>/qalist.php" class="link_qa btn_s btn_b01">1:1 문의</a>
        </div>
    </div>
