...
<div class="sit_left">
    <div id="sit_ov_wrap">
        ...
        <section id="sit_ov" class="2017_renewal_itemform">
            ...
            <div class="sns_area">
                <a href="javascript:item_wish(document.fitem, '<?php echo $it['it_id']; ?>');" id="sit_btn_wish"><i class="fa fa-heart-o" aria-hidden="true"></i><span> 위시리스트(<?php echo get_wishlist_count_by_item($it['it_id']); ?>)</span></a>
...
<div id="option_wr">
    ...
    <!-- 총 구매액 -->
        ...
        <button type="submit" onclick="document.pressed=this.value;" value="장바구니" id="sit_btn_cart" class="btn btn_b01">장바구니</button>
        <?php } ?>
