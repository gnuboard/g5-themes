...
<div id="nav">
    <ul>
        <li><button type="button" class="cate_btn"><i class="fa fa-bars"></i><span class="txt">카테고리</span></button></li>
        <li><a href="<?php echo G5_SHOP_URL; ?>/mypage.php"><i class="fa fa-user-o"></i><span class="txt">마이페이지</span></a></li>
        <li><a href="<?php echo G5_SHOP_URL; ?>/wishlist.php"><i class="fa fa-heart-o"></i><span class="txt">위시리스트</span></a></li>
        <li>
...
<!-- 커뮤니티 최신글 시작 { -->
<?php echo latest('theme/shop_basic', 'notice', 1, 30); ?>
<div id="ft">
