...
for ($i=0; $row=sql_fetch_array($result); $i++) {
    ...
    echo "<li class=\"sct_li{$li_clear}\"><div class=\"li_wr box is_view_type_list\">\n";
    ...
    if ($this->href) {
     ...
     echo "<button type=\"button\" class=\"btn_cart\" data-it_id=\"{$row['it_id']}\"><i class=\"fa fa-shopping-cart\" aria-hidden=\"true\"></i> <span class=\"txt\">장바구니</span></button>\n";
