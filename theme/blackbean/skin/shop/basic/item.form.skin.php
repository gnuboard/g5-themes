...
<div id="sit_ov_wrap">
    ...
    <div id="sit_pvi">
	    ...
	    <div id="sit_star_sns">
			<div class="sns_area">
	    		<?php echo $sns_share_links; ?> <a href="javascript:popup_item_recommend('<?php echo $it['it_id']; ?>');" id="sit_btn_rec"><i class="fa fa-envelope-o" aria-hidden="true"></i><span class="sound_only">추천하기</span></a>
	    	</div>
    ...
    <section id="sit_ov" class="2017_renewal_itemform">
        ...
        <div id="sit_ov_btn">
            <?php if ($is_orderable) { ?>
            <button type="submit" onclick="document.pressed=this.value;" value="장바구니" id="sit_btn_buy">장바구니</button>
	...
	<div id="sit_siblings">
	    ...
	    if ($prev_href || $next_href) {
	    	$prev_title = '<i class="fa fa-angle-left" aria-hidden="true"></i> '.$prev_title;
	        $next_title = $next_title.' <i class="fa fa-angle-right" aria-hidden="true"></i>';
