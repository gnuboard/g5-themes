...
<section id="idx_ct">
    <div class="idx_cnt">
        <div class="col50">
            ...
            <!-- 매장안내 -->
            <div class="contact">
                <a href="<?php echo get_pretty_url('content', 'contact'); ?>">
        ...
        <div class="company col50">
            <p><a href="<?php echo get_pretty_url('content', 'company'); ?>"><img src="<?php echo G5_THEME_URL; ?>/img/company.png" alt="회사소개"><br>자세히보기 <i class="fa fa-angle-right fa-fw"></i></a></p>
        </div>
    </div>
