...
<div id="sod_bsk">
    ...
    <div class="sod_bsk_left">
        ...
        <ul class="cart_list">
            ...
            for ($i=0; $row=sql_fetch_array($result); $i++)
            {
                ...
                if($it_options) {
                    $mod_options = '<button type="button" id="mod_opt_'.$row['it_id'].'" class="mod_btn mod_options btn_b01">선택사항수정</button>';
                   // $it_name .= ;
                }
            ...
            <li class="sod_li">
                <div class="li_wr">
                    ...
                    <div class="li_name">
                        <span class="li_chk bo_chk">
                            <label for="ct_chk_<?php echo $i; ?>"><span class="chk_img"></span> <span class="sound_only">상품선택</span></label>
                    ...
                    <div class="total_img"><?php echo $image; ?></div>
                     ...
                     <ul class="li_prqty">
                        <li class="prqty_price li_prqty_sp"><span>판매가 </span><?php echo number_format($row['ct_price']); ?></li>
                        <li class="prqty_qty li_prqty_sp"><span>수량 </span><?php echo number_format($sum['qty']); ?></li>
                        <li class="prqty_sc li_prqty_sp"><span>배송비 </span><?php echo $ct_send_cost; ?></li>
                        <li class="total_point li_prqty_sp"><span>적립포인트 </span><strong><?php echo number_format($sum['point']); ?></strong></li>
                    </ul>
    ...
    <div class="sod_ta_wr">
        <?php if ($i == 0) { ?>
        <div class="go_shopping"><a href="<?php echo G5_SHOP_URL; ?>/" class="btn_b01">쇼핑 계속하기</a></div>
        <?php } else { ?>
        ...
        <div id="sod_bsk_act" class="btn_confirm">
            ...
            <button type="button" onclick="return form_check('buy');" class="btn_submit btn_b02">주문하기</button>
