...
<article id="bo_v">
	<div class="bo_v_innr">
        ...
        <section id="bo_v_info">
            ...
            <button class="bo_v_opt"><span class="sound_only">게시물 옵션</span><i class="fa fa-ellipsis-v" aria-hidden="true"></i></button>
            <ul id="bo_v_opt" class="bo_v_com">
                ...
                <?php if ($delete_href) { ?><li><a href="<?php echo $delete_href ?>" onclick="del(this.href); return false;"><i class="far fa-trash-alt"></i> 삭제</a></li><?php } ?>
            </ul>
            <?php } ?>
        ...
        <section id="bo_v_contact">
            ...
            <dl>
                <?php if($view['email']) { ?>
                <dt><i class="far fa-envelope"></i><span class="sound_only">이메일</span></dt>
