...
<section id="bo_v_ans">
    ...
    <a href="<?php echo $rewrite_href; ?>" class="btn add_qa btn_s"><i class="fa fa-plus-circle" aria-hidden="true"></i> 추가질문</a>
    ...
    <div id="ans_add">
        ...
        <a href="<?php echo $answer_update_href; ?>" class="btn_b01 btn btn_s">답변수정</a>
        <?php } ?>
        <?php if($answer_delete_href) { ?>
        <a href="<?php echo $answer_delete_href; ?>" class="btn_b01 btn btn_s" onclick="del(this.href); return false;">답변삭제</a>
        <?php } ?>
    </div>
</section>