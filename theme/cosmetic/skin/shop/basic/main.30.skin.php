...
for ($i=1; $row=sql_fetch_array($result); $i++) {
    ...
    echo "<li class=\"sct_li {$sct_last}\" style=\"padding-left:{$this->img_width}px;min-height:{$this->img_height}px\"><div class=\"sct_wr\">\n";
    ...
    if ($this->view_it_img) {
        echo "<span>".get_it_image($row['it_id'], $this->img_width, $this->img_height, '', '', stripslashes($row['it_name']))."</span>\n";
    }
    if ($this->href) {
        echo "</a>\n";
    }
