...
<div id="sbsk" class="tnb_con">
    <div class="tnb_con_wr">
        ...
        for ($i=0; $row=sql_fetch_array($result); $i++)
        {
            ...
            echo '</div>'.PHP_EOL;
            echo '<button class="cart_del prd_del" type="button" data-it_id="'.$row['it_id'].'"><span class="sound_only">삭제</span><i class="fa fa-trash"></i></button>'.PHP_EOL;
            echo '</li>'.PHP_EOL;
        }
        ...
        <div class="cart_btn qk_cart_btn">
            ...
            <a href="<?php echo G5_SHOP_URL; ?>/cart.php" class="qk_go_cart btn btn_m">장바구니 가기</a>
        </div>
        </form>
     </div>
  </div>
