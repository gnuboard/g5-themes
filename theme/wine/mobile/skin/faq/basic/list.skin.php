...
<div id="faq_wr">
    <div id="cs_top">
        <div id="faq_sch"> 
            ...
            <button type="submit" class="btn_submit"><span class="sound_only">검색</span><i class="fa fa-search"></i></button>
            </form>
        </div>
        <div class="cs_top_wr cs_top_qa">
            <p>찾으시는 답변이 없으면 <br><strong>1:1문의하기</strong>를 이용해 주세요.</p>
            <a href="<?php echo G5_BBS_URL; ?>/qalist.php" class="btn_b01">1:1 문의하기</a>
        </div>
