...
<div id="ft">
    ...
    <div class="ft_wr"> 
        ...
        <div id="ft_cs" class="ft_con">
            ...
            <div>
                ...
                <a href="<?php echo G5_BBS_URL; ?>/faq.php" class="qa_link btn_b01">고객센터</a>
            </div>
        </div>
        <div class="ft_con">
    ...
    <button type="button" id="top_btn"><i class="fa fa-chevron-up" aria-hidden="true"></i></button>
    <script>
