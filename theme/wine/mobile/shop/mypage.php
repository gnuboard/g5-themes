...
<div id="smb_my">
    ...
    <section id="smb_my_ov">
        ...
        <div class="my_cou_wr">
            <div class="my_cou"><img src="<?php echo G5_THEME_URL; ?>/img/icon-cp.png"><a href="<?php echo G5_SHOP_URL; ?>/coupon.php" target="_blank" class="win_coupon"><span>쿠폰</span><?php echo number_format($cp_count); ?></a></div>
            <div class="my_po"><img src="<?php echo G5_THEME_URL; ?>/img/icon-po.png"><a href="<?php echo G5_BBS_URL; ?>/point.php" target="_blank" class="win_point"><span>포인트</span><?php echo number_format($member['mb_point']); ?>점</a></div>
        </div>
        <dl class="my_info">
            <dt>연락처</dt>
