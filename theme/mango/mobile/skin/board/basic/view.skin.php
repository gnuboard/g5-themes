...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_info">
        <h2>페이지 정보</h2>
        <?php echo $view['name'] ?><span class="ip"><?php if ($is_ip_view) { echo "&nbsp;($ip)"; } ?>
        <span class="if_sp"><?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?> </span>
        <span class="if_sp">조회 <?php echo number_format($view['wr_hit']) ?>회 </span>
        <span class="if_sp">댓글 <?php echo number_format($view['wr_comment']) ?>건</span>
        <?php
        ob_start();
         ?>
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_act">
            ...
            <span class="bo_v_act_gng">
                <a href="<?php echo $good_href.'&amp;'.$qstr ?>" id="good_button"  class="bo_v_good "><i class="fa fa fa-thumbs-o-up" aria-hidden="true"></i> <span class="sound_only">추천</span><strong><?php echo number_format($view['wr_good']) ?></strong></a>
        ...
        ?>
        <div id="bo_v_act">
            <?php if($board['bo_use_good']) { ?><span class="bo_v_good "><i class="fa fa fa-thumbs-o-up" aria-hidden="true"></i> <span class="sound_only">추천</span><strong><?php echo number_format($view['wr_good']) ?></strong></span><?php } ?>
        ...
        ?>
        <div id="bo_v_share">
            <?php if ($scrap_href) { ?><a href="<?php echo $scrap_href;  ?>" target="_blank" class=" btn_scrap" onclick="win_scrap(this.href); return false;"><i class="fa fa-thumb-tack"></i> 스크랩</a><?php } ?>
