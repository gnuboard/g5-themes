    ...
    <div class="inner_bottom">
        <div id="ans_datetime">
            ...
            <ul id="bo_cv_opt">
                ...
                <li><a href="<?php echo $answer_update_href; ?>">답변수정 <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></li>
                <?php } ?>
                <?php if($answer_delete_href) { ?>
                <li><a href="<?php echo $answer_delete_href; ?>" onclick="del(this.href); return false;">답변삭제 <i class="far fa-trash-alt"></i></a></li>
                <?php } ?>
            </ul>
            <?php } ?>
        </div>
