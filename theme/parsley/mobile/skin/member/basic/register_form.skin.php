    ...
    <div class="form_01">
        ...
        <ul>
            <li>
                ...
                <div class="frm_info">영문자, 숫자, _ 만 입력 가능. 최소 3자이상 입력하세요.</div>
            </li>
            <li class="password">
        ...
        <ul>
            ...
            <li class="chk_box">
                ...
                <label for="reg_mb_mailling">
                    ...
                    <div class="chk_li">정보 메일을 받겠습니다.</div>
                </label>
            </li>
            ...
            <li class="chk_box">
                ...
                <label for="reg_mb_sms">
                    ...
                    <div class="chk_li">휴대폰 문자메세지를 받겠습니다.</div>
                </label>        
            </li>
            <?php } ?>
            ...
            <li class="chk_box">
                ...
                <label for="reg_mb_open">
                    ...
                    <div class="chk_li">다른분들이 나의 정보를 볼 수 있도록 합니다.</div>
                </label>      
                <div class="frm_info">
