...
<article id="bo_v" style="width:<?php echo $width; ?>">
	    ...
	    <header class="bo_top_hd">
	        ...
	        <div id="bo_v_info">
		        ...
		        <div class="profile_info">
		        	...
		        	<span class="sound_only">작성일</span><strong><i class="fa fa-clock-o" aria-hidden="true"></i> <?php echo date("y-m-d H:i", strtotime($view['wr_datetime'])) ?></strong>
	...
	<div id="bo_btn">
		...
		<div class="btn_top top">
			...
			<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="btn_b02 btn">글쓰기</a><?php } ?>
		</div>
	</div>
